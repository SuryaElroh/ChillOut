...
import * as import13 from 'ionic-angular/components/menu/menu';
...
import * as import27 from '../node_modules/ionic-angular/components/toolbar/toolbar.ngfactory';
...
import * as import35 from '../node_modules/ionic-angular/components/nav/nav.ngfactory';
import * as import36 from 'ionic-angular/navigation/nav-controller-base';
...
class _View_MyApp_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MyApp_0_4 = new import3.MyApp(this.parentInjector.get(import8.Platform),this.parentInjector.get(import9.MenuController));
...
export const MyAppNgFactory:import11.ComponentFactory<import3.MyApp> = new import11.ComponentFactory<import3.MyApp>('ng-component',viewFactory_MyApp_Host0,import3.MyApp);
...
class _View_MyApp0 extends import1.AppView<import3.MyApp> {
  ...
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _Menu_0_4:import13.Menu;
  _query_Content_0_0:import12.QueryList<any>;
  _text_1:any;
  _el_2:any;
  _Header_2_3:import14.Header;
  _text_3:any;
  _el_4:any;
  /*private*/ _appEl_4:import2.AppElement;
  _Toolbar_4_4:import14.Toolbar;
  _text_5:any;
  _el_6:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Menu_0_4 = new import13.Menu(this.parentInjector.get(import9.MenuController),new import21.ElementRef(this._el_0),this.parentInjector.get(import22.Config),this.parentInjector.get(import8.Platform),this.renderer,this.parentInjector.get(import23.Keyboard),this.parentInjector.get(import24.NgZone),this.parentInjector.get(import25.GestureController));
    ...
    this._Header_2_3 = new import14.Header(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    ...
    var compView_4:any = import27.viewFactory_Toolbar0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Toolbar_4_4 = new import14.Toolbar(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import15.ToolbarTitle(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4,this.parentInjector.get(import29.Navbar,(null as any)));
    ...
    var compView_11:any = import30.viewFactory_Content0(this.viewUtils,this.injector(11),this._appEl_11);
    this._Content_11_4 = new import16.Content(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_11),this.renderer,this.parentInjector.get(import31.App),this.parentInjector.get(import23.Keyboard),this.parentInjector.get(import24.NgZone),this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import32.Tabs,(null as any)));
    ...
    this._List_13_3 = new import17.List(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import25.GestureController));
    ...
    this._NgFor_15_6 = new import18.NgFor(this._appEl_15.vcRef,this._TemplateRef_15_5,this.parentInjector.get(import34.IterableDiffers),this.ref);
    ...
    var compView_20:any = import35.viewFactory_Nav0(this.viewUtils,this.injector(20),this._appEl_20);
    this._Nav_20_4 = new import19.Nav(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import36.NavControllerBase,(null as any)),this.parentInjector.get(import31.App),this.parentInjector.get(import22.Config),this.parentInjector.get(import23.Keyboard),new import21.ElementRef(this._el_20),this.parentInjector.get(import24.NgZone),this.renderer,this.parentInjector.get(import37.ComponentFactoryResolver),this.parentInjector.get(import25.GestureController),this.parentInjector.get(import38.TransitionController),this.parentInjector.get(import39.DeepLinker,(null as any)));
    this._appEl_20.initComponent(this._Nav_20_4,[],compView_20);
    compView_20.create(this._Nav_20_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import14.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._Toolbar_4_4; }
    if (((token === import14.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) { return this._Header_2_3; }
    if (((token === import33.TemplateRef) && (15 === requestNodeIndex))) { return this._TemplateRef_15_5; }
    if (((token === import18.NgFor) && (15 === requestNodeIndex))) { return this._NgFor_15_6; }
    if (((token === import17.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._List_13_3; }
    if (((token === import16.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_11_4; }
    if (((token === import13.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Menu_0_4; }
    if (((token === import19.Nav) && (20 === requestNodeIndex))) { return this._Nav_20_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changed = false;
    const currVal_0:any = this._Nav_20_4;
    ...
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._Nav_20_4.swipeBackEnabled = currVal_5;
    ...
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Nav_20_4.ngAfterViewInit(); } }
  }
...
export function viewFactory_MyApp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MyApp> {
  if ((renderType_MyApp === (null as any))) { (renderType_MyApp = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/.tmp/app/app.html',0,import10.ViewEncapsulation.None,styles_MyApp,{})); }
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Item_0_4 = new import40.Item(this.parent.parentInjector.get(import42.Form),this.parent.parentInjector.get(import22.Config),new import21.ElementRef(this._el_0),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import40.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Item_0_4; }
    if (((token === import40.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
