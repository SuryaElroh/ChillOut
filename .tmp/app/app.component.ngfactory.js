...
export var MyAppNgFactory = new import11.ComponentFactory('ng-component', viewFactory_MyApp_Host0, import3.MyApp);
var styles_MyApp = [];
...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_2_3 = new import14.Header(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import26.ViewController, null));
        ...
        var compView_4 = import27.viewFactory_Toolbar0(this.viewUtils, this.injector(4), this._appEl_4);
        this._Toolbar_4_4 = new import14.Toolbar(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_4), this.renderer);
        ...
        this._ToolbarTitle_6_4 = new import15.ToolbarTitle(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4, this.parentInjector.get(import29.Navbar, null));
        ...
        var compView_11 = import30.viewFactory_Content0(this.viewUtils, this.injector(11), this._appEl_11);
        this._Content_11_4 = new import16.Content(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_11), this.renderer, this.parentInjector.get(import31.App), this.parentInjector.get(import23.Keyboard), this.parentInjector.get(import24.NgZone), this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import32.Tabs, null));
        ...
        var compView_20 = import35.viewFactory_Nav0(this.viewUtils, this.injector(20), this._appEl_20);
        this._Nav_20_4 = new import19.Nav(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import36.NavControllerBase, null), this.parentInjector.get(import31.App), this.parentInjector.get(import22.Config), this.parentInjector.get(import23.Keyboard), new import21.ElementRef(this._el_20), this.parentInjector.get(import24.NgZone), this.renderer, this.parentInjector.get(import37.ComponentFactoryResolver), this.parentInjector.get(import25.GestureController), this.parentInjector.get(import38.TransitionController), this.parentInjector.get(import39.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import14.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._Toolbar_4_4;
        }
        if (((token === import14.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
            return this._Header_2_3;
        }
        if (((token === import33.TemplateRef) && (15 === requestNodeIndex))) {
            return this._TemplateRef_15_5;
        }
        if (((token === import18.NgFor) && (15 === requestNodeIndex))) {
            return this._NgFor_15_6;
        }
        if (((token === import17.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._List_13_3;
        }
        if (((token === import16.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
            return this._Content_11_4;
        }
        if (((token === import13.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._Menu_0_4;
        }
        if (((token === import19.Nav) && (20 === requestNodeIndex))) {
...
export function viewFactory_MyApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MyApp === null)) {
        (renderType_MyApp = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/.tmp/app/app.html', 0, import10.ViewEncapsulation.None, styles_MyApp, {}));
    }
