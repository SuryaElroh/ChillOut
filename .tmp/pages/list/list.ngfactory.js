...
var _View_ListPage_Host0 = (function (_super) {
    ...
    _View_ListPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        compView_0.create(this._ListPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_ListPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.ListPage) && (0 === requestNodeIndex))) {
            return this._ListPage_0_4;
        }
...
export var ListPageNgFactory = new import11.ComponentFactory('ng-component', viewFactory_ListPage_Host0, import3.ListPage);
var styles_ListPage = [];
...
export function viewFactory_ListPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ListPage === null)) {
        (renderType_ListPage = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/.tmp/pages/list/list.html', 0, import10.ViewEncapsulation.None, styles_ListPage, {}));
    }
