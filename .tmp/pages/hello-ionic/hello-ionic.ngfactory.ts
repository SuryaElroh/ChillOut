...
var renderType_HelloIonicPage_Host:import0.RenderComponentType = (null as any);
class _View_HelloIonicPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _HelloIonicPage_0_4:import3.HelloIonicPage;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    compView_0.create(this._HelloIonicPage_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.HelloIonicPage) && (0 === requestNodeIndex))) { return this._HelloIonicPage_0_4; }
    return notFoundResult;
  }
}
function viewFactory_HelloIonicPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_HelloIonicPage_Host === (null as any))) { (renderType_HelloIonicPage_Host = viewUtils.createRenderComponentType('',0,import8.ViewEncapsulation.None,[],{})); }
  return new _View_HelloIonicPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const HelloIonicPageNgFactory:import9.ComponentFactory<import3.HelloIonicPage> = new import9.ComponentFactory<import3.HelloIonicPage>('ng-component',viewFactory_HelloIonicPage_Host0,import3.HelloIonicPage);
const styles_HelloIonicPage:any[] = [];
var renderType_HelloIonicPage:import0.RenderComponentType = (null as any);
class _View_HelloIonicPage0 extends import1.AppView<import3.HelloIonicPage> {
  _el_0:any;
  ...
  _Button_27_4:import12.Button;
  _MenuToggle_27_5:import13.MenuToggle;
  _ToolbarItem_27_6:import14.ToolbarItem;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MenuToggle_4_5 = new import13.MenuToggle(this.parentInjector.get(import26.MenuController),new import20.ElementRef(this._el_4),this.parentInjector.get(import21.ViewController,(null as any)),this._Navbar_2_4);
    this._ToolbarItem_4_6 = new import14.ToolbarItem(this.parentInjector.get(import19.Config),new import20.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import10.Toolbar,(null as any)),this._Navbar_2_4);
    ...
    this._ToolbarTitle_9_4 = new import17.ToolbarTitle(this.parentInjector.get(import19.Config),new import20.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import10.Toolbar,(null as any)),this._Navbar_2_4);
    ...
    var compView_27:any = import25.viewFactory_Button0(this.viewUtils,this.injector(27),this._appEl_27);
    ...
    this._MenuToggle_27_5 = new import13.MenuToggle(this.parentInjector.get(import26.MenuController),new import20.ElementRef(this._el_27),this.parentInjector.get(import21.ViewController,(null as any)),this.parentInjector.get(import11.Navbar,(null as any)));
    this._ToolbarItem_27_6 = new import14.ToolbarItem(this.parentInjector.get(import19.Config),new import20.ElementRef(this._el_27),this.renderer,this.parentInjector.get(import10.Toolbar,(null as any)),this.parentInjector.get(import11.Navbar,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import12.Button) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._Button_27_4; }
    if (((token === import13.MenuToggle) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._MenuToggle_27_5; }
    if (((token === import14.ToolbarItem) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._ToolbarItem_27_6; }
    if (((token === import18.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._Content_14_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_11:any = this._MenuToggle_27_5.isHidden;
...
export function viewFactory_HelloIonicPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.HelloIonicPage> {
  if ((renderType_HelloIonicPage === (null as any))) { (renderType_HelloIonicPage = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/.tmp/pages/hello-ionic/hello-ionic.html',0,import8.ViewEncapsulation.None,styles_HelloIonicPage,{})); }
