...
export function viewFactory_ItemDetailsPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ItemDetailsPage === null)) {
        (renderType_ItemDetailsPage = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/.tmp/pages/item-details/item-details.html', 0, import10.ViewEncapsulation.None, styles_ItemDetailsPage, {}));
    }
...
var _View_ItemDetailsPage1 = (function (_super) {
    ...
    _View_ItemDetailsPage1.prototype.createInternal = function (rootSelector) {
        ...
        this._MenuToggle_0_3 = new import28.MenuToggle(this.parent.parentInjector.get(import32.MenuController), new import18.ElementRef(this._el_0), this.parent.parentInjector.get(import19.ViewController, null), this.parent._Navbar_2_4);
        this._ToolbarItem_0_4 = new import29.ToolbarItem(this.parent.parentInjector.get(import17.Config), new import18.ElementRef(this._el_0), this.renderer, this.parent.parentInjector.get(import12.Toolbar, null), this.parent._Navbar_2_4);
        this._query_Button_0_0 = new import30.QueryList();
        this._text_1 = this.renderer.createText(this._el_0, '\n      ', null);
    ...
    _View_ItemDetailsPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import31.Icon) && (2 === requestNodeIndex))) {
            return this._Icon_2_3;
        }
        if (((token === import28.MenuToggle) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._MenuToggle_0_3;
        }
        if (((token === import29.ToolbarItem) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
...
var _View_ItemDetailsPage2 = (function (_super) {
    ...
    _View_ItemDetailsPage2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import31.Icon) && (5 === requestNodeIndex))) {
