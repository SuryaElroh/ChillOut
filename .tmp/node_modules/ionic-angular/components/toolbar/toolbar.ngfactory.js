...
export function viewFactory_Toolbar0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Toolbar === null)) {
        (renderType_Toolbar = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/toolbar/toolbar.d.ts class Toolbar - inline template', 4, import11.ViewEncapsulation.None, styles_Toolbar, {}));
    }
