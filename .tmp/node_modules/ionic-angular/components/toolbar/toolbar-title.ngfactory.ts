...
export function viewFactory_ToolbarTitle0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ToolbarTitle> {
  if ((renderType_ToolbarTitle === (null as any))) { (renderType_ToolbarTitle = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/toolbar/toolbar-title.d.ts class ToolbarTitle - inline template',1,import12.ViewEncapsulation.None,styles_ToolbarTitle,{})); }
