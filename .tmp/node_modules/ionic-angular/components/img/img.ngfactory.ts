...
export function viewFactory_Img0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Img> {
  if ((renderType_Img === (null as any))) { (renderType_Img = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/img/img.d.ts class Img - inline template',0,import12.ViewEncapsulation.None,styles_Img,{})); }
