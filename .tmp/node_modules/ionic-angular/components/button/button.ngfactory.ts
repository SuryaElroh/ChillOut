...
export function viewFactory_Button0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Button> {
  if ((renderType_Button === (null as any))) { (renderType_Button = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/button/button.d.ts class Button - inline template',1,import10.ViewEncapsulation.None,styles_Button,{})); }
