...
export function viewFactory_Button0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Button === null)) {
        (renderType_Button = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/button/button.d.ts class Button - inline template', 1, import10.ViewEncapsulation.None, styles_Button, {}));
    }
