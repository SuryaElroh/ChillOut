...
export function viewFactory_Content0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Content === null)) {
        (renderType_Content = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/content/content.d.ts class Content - inline template', 3, import15.ViewEncapsulation.None, styles_Content, {}));
    }
