...
export function viewFactory_Toggle0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Toggle> {
  if ((renderType_Toggle === (null as any))) { (renderType_Toggle = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/toggle/toggle.d.ts class Toggle - inline template',0,import14.ViewEncapsulation.None,styles_Toggle,{})); }
