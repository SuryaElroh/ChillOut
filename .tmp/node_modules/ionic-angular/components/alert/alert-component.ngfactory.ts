...
export function viewFactory_AlertCmp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AlertCmp> {
  if ((renderType_AlertCmp === (null as any))) { (renderType_AlertCmp = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/alert/alert-component.d.ts class AlertCmp - inline template',0,import12.ViewEncapsulation.None,styles_AlertCmp,{})); }
