...
export function viewFactory_Spinner0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Spinner> {
  if ((renderType_Spinner === (null as any))) { (renderType_Spinner = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/spinner/spinner.d.ts class Spinner - inline template',0,import10.ViewEncapsulation.None,styles_Spinner,{})); }
