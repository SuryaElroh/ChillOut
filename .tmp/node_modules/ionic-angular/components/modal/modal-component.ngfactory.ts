...
export function viewFactory_ModalCmp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ModalCmp> {
  if ((renderType_ModalCmp === (null as any))) { (renderType_ModalCmp = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/modal/modal-component.d.ts class ModalCmp - inline template',0,import11.ViewEncapsulation.None,styles_ModalCmp,{})); }
