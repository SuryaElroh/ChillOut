...
export function viewFactory_ToastCmp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ToastCmp> {
  if ((renderType_ToastCmp === (null as any))) { (renderType_ToastCmp = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/toast/toast-component.d.ts class ToastCmp - inline template',0,import12.ViewEncapsulation.None,styles_ToastCmp,{})); }
