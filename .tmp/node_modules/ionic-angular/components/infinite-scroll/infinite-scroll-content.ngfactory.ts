...
export function viewFactory_InfiniteScrollContent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.InfiniteScrollContent> {
  if ((renderType_InfiniteScrollContent === (null as any))) { (renderType_InfiniteScrollContent = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/infinite-scroll/infinite-scroll-content.d.ts class InfiniteScrollContent - inline template',0,import10.ViewEncapsulation.None,styles_InfiniteScrollContent,{})); }
