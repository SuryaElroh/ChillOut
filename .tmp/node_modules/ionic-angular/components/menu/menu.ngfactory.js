...
export function viewFactory_Menu0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Menu === null)) {
        (renderType_Menu = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/menu/menu.d.ts class Menu - inline template', 1, import16.ViewEncapsulation.None, styles_Menu, {}));
    }
