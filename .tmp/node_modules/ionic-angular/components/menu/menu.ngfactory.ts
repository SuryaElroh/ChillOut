...
export function viewFactory_Menu0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Menu> {
  if ((renderType_Menu === (null as any))) { (renderType_Menu = viewUtils.createRenderComponentType('D:/Surya/GitHub/testChillOut/node_modules/ionic-angular/components/menu/menu.d.ts class Menu - inline template',1,import16.ViewEncapsulation.None,styles_Menu,{})); }
